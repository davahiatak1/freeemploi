<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('FreeLance') ?> "> <strong>Free Emploi |</strong> Freelance</a>
        </div>
        <?php if (!$this->session->userdata('nom')): ?>
            <div  id="navbar" class="navbar-collapse collapse">

                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo site_url('accueil/') ?>"><span><i style="margin-right: 5px;margin-top: 10px" class="glyphicon glyphicon-home"></i></span>Tableau de bord</a></li>
                    ...
                    <li><a href="<?php echo site_url('accueil/inscription') ?>"><span><i style="margin-right: 5px;margin-top: 10px" class="glyphicon glyphicon-plus-sign"></i></span>S'inscrire</a></li>
            ...
            <?php if ($this->session->userdata('nom')): ?>
                ...
                <ul class="nav navbar-nav pull-right">
                    <li><a href="<?php echo site_url('accueil/') ?>"><span><i style="margin-right: 5px;margin-top: 20px" class="glyphicon glyphicon-home"></i></span>Tableau de bord</a></li>
                    <li role="presentation" class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="margin-left: -75px">
                            <li><a style="color: black"class="navbar-link disabled"><?php echo $this->session->userdata('nom'); ?></a></li>
                            <li><a class="navbar-link text-primary" href="<?php echo site_url('freeLance/update') ?>"><strong class="text-info">Mon Compte</strong></a></li>
                            <li><a class="navbar-link text-primary" href="<?php echo site_url('accueil/deco') ?>"><strong class="text-info">Se déconnecter</strong></a></li>
                        </ul>
                    </li>
