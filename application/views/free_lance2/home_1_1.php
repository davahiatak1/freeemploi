                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading"> 
                                    <div class="media">
                                        ...
                                        <h4 style="margin-top: 50px" class="media-heading"><?php echo $post['nom']; ?></h4>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div>
                                        ...
                                        <p >
                                            <strong>Competence</strong>:<?php foreach ($compet as $comp) {
                                                echo $comp." "; 
                                            }           
                                                 ?> 
                                        </p>
        ...
        <!--                                        <form method="post" action="<?php echo site_url('freeLance/profil') ?>">
                                ...
                                <div class="panel-footer">
                                    <p>
                                        ...
                                        <a href="<?= site_url('accueil/inscription') ?>" class="btn btn-xs btn-default "><span class="glyphicon glyphicon-bookmark"></span> Contacter</a>
                                        <?php endif; ?>
                                        <?php if($this->session->userdata('nom')): ?>
                                        <a id="idPostulant-<?=$post['idPostulant'] ?>"  class="btn btn-xs btn-default voirContact"><span class="glyphicon glyphicon-bookmark"></span> Contacter</a>
                                        <?php endif; ?>
                                    </p>
                                </div>
                            </div> 
